...
function Project() {
  return (
    <>
      ...
      <h3 className="flex max-w-screen-xl mx-auto items-start justify-start font-bold text-xl mb-5">
        Current Projects
      </h3>
      <div className="flex max-w-screen-xl mx-auto items-center justify-center">
        <Swiper
          ...
          modules={[Pagination]}
          className="mySwiper center mb-8"
          breakpoints={{
      ...
      <h1 className="flex max-w-screen-xl mx-auto items-start justify-start font-bold text-xl mb-5 mt-8">
      ...
      <div className="flex max-w-screen-xl mx-auto items-center justify-center">
        <Swiper
          ...
          modules={[Pagination]}
          className="mySwiper center mb-12"
          breakpoints={{
            // when window width is >= 640px
            640: {
              width: 640,
