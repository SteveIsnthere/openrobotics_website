...
const Recruitment = () => {
    ...
    return (
        <section
            className="flex flex-col m-[10%] py-10 md:mt-24 sm:mt-30 xs:mt-60 sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl justify-center items-center">
            ...
            <p className="py-4 text-md md:text-xl  text-gray-500">
                Our Recruitment cycle is in full swing right now! If you're
                ...
                <b>Note:</b> We strongly encourage anyone with a strong interest and passion to design and manufacture
                to apply,
            ...
            {/*</button>*/}
            <button
                className="bg-gray-900 w-auto font-bold rounded-lg mt-8 md:mt-16 px-20 py-3 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 duration-300 hover:bg-red-600  text-gray-200 text-center">
                <a
                    className="style-none"
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://forms.gle/qDBaXs8f3Eg73nKj9"
                >
                    Apply Now
                </a>
            </button>
