...
const  Position = (props:Props) =>{
  ...
  return (
    <div className='flex flex-col w-full py-4'>
             <div className={'flex py-4 mt-4 flex-row justify-between text-center items-start font-bold rounded-lg border-b-2 border-l-2 border-r-2 border-gray-200 bg-gray-200 text-gray-900 w-full ' + removeBorder(arrow)} onClick={() => setArrow(!arrow)}>
