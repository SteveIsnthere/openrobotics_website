        ...
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            <a
              ...
              title="Instagram"
              className="flex text-2xl items-center justify-center cursor-pointer w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-red-500 text-gray-900 hover:bg-gray-300"
            >
              <AiFillLinkedin />
            </a>
            <a
            ...
            <a
              rel="noopener noreferrer"
              href="mailto:ubcopenrobotics@gmail.com"
              title="Instagram"
              className="flex text-2xl items-center justify-center cursor-pointer w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-red-500 text-gray-900 hover:bg-gray-300"
            >
              <AiFillMail />
