          ...
          <div className="container">
            <div className="flex flex-wrap items-center">
              ...
              <h2 className="mb-9 wow">
                ...
                potentially adopting other instruments, such as to form an
                entire band of robots. The "Pianobot" name is expected to change
                      ...
                      <div className="m-3">
                        ...
                        <div className="features-content">
                          ...
                          <p>
                            ...
                            for music and robotics to combine their interests
                            into one fun project!
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="w-full sm:w-1/2 lg:w-1/2">
                      <div className="m-3">
                        ...
                        <div className="features-content">
                          ...
                          <p>
                            {" "}
                            Hopefully, open to more song requests later on.
                            (Robot head may or may not be included).
                          </p>
                        </div>
                      </div>
                    </div>
