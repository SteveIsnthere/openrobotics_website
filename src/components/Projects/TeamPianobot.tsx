...
const Team = () => {
  ...
  const PianoBot: Array<Person> = [
    new Person(
      ...
      "im",
      "im",
      "assets/img/pianobot/shawna.png",
      "im"
    ),
    new Person(
      "Veronica Nguyen",
      ...
      "im",
      "im",
      "assets/img/pianobot/veronica.png",
      "im"
    ),
    new Person(
      "Evan Liu",
    ...
    new Person(
      ...
      "im",
      "im",
      "assets/img/pianobot/fernando.png",
      "im"
    ),
    new Person(
      ...
      "im",
      "im",
      "assets/img/pianobot/karthik.png",
      "im"
    ),
    new Person(
      "Prayus Shrestha",
      ...
      "im",
      "im",
      "assets/img/pianobot/prayus.png",
      "im"
    ),
    new Person(
      "Ryan Acapulco",
    ...
    new Person(
      ...
      "im",
      "im",
      "assets/img/pianobot/yiting.png",
      "im"
    ),
  ];
