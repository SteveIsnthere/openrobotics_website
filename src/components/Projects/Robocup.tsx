        ...
        <div className="container">
          <div className="flex flex-wrap items-center">
            ...
            <h2 className="mb-9 wow">
              ...
              total of the mechanism or may be part of a more complex robot. The
              links of such a manipulator are connected by joints allowing
                  ...
                  <div className="w-full sm:w-1/2 lg:w-1/2">
                    <div className="m-3">
                      ...
                      <div className="features-content">
                        ...
                        <p>
                          {" "}
                          The RoboCup@Home project allows students to apply and
                          strengthen their knowledge of mechanical, electrical,
                          and software design through the annual international
                    ...
                    <div className="m-3">
                      ...
                      <div className="features-content">
                        ...
                        <p>
                          ...
                          robot technology highly relevant for personal domestic
                          use. It is the largest international annual
                          competition for autonomous service robots and is part
                          of the RoboCup initiative
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="w-full sm:w-1/2 lg:w-1/2">
                    <div className="m-3">
                      ...
                      <div className="features-content">
                        ...
                        <p>
                          We will continue developing the software architecture,
                          which will pave the path for the Robocup@Home 2021
                          Open League Challenge as well as expand our
                          relationship with the Robocup@Home Community across
                          North America and lead initiatives that promote
                          robotics.
                        </p>
                      </div>
                    </div>
