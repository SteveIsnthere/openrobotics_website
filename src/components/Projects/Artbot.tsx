          ...
          <div className="container">
            <div className="flex flex-wrap items-center">
              ...
              <h2 className="mb-9 wow">
                ...
                art, beautiful art. The Artbot project is a unique opportunity
                for students to learn more about the intricacies of visual arts
                by building a robot that can paint 2D compositions.
                Participating in the international RobotArt competition,
                students are focusing on constructing a delta robot to create
                both abstract art pieces, and modern (robot) interpretations of
                classic works.
              </h2>
                      ...
                      <div className="m-3">
                        ...
                        <div className="features-content">
                          ...
                          <p>
                            ...
                            students to learn more about the intricacies of
                            visual arts by building a robot that can paint 2D
                            compositions!
                          </p>
                        </div>
                      </div>
