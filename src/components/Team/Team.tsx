...
const Team = () => {
    ...
    const Leads: Array<Person> = [
        new Person("Juan Diego Balestrini", 'OpBots Captain', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
    ...
    const Admin: Array<Person> = [
        new Person("Sahib Rao", 'Web Developer', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
        new Person("Steve Wang", 'Web Developer', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
        new Person("Kunal Bhasin", 'Graphic Designer', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
        new Person("Shoue Nariyoshi", 'Social Media Manager', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
    ...
    const PianoBot: Array<Person> = [
        new Person("Samuel Krisetia", 'Mechanical/Electrical Lead', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
        new Person("Ryan Luke Acapulco", 'Software Lead', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
    ...
    const ArtBot: Array<Person> = [
        ...
        new Person("Navneeth Devadas", 'ArtBot Member', 'im', 'im', 'assets/img/default_profile.jpg', 'im'),
        new Person("Felice Jie Chen", 'ArtBot Member', 'im', 'im', 'assets/img/default_profile.jpg', 'im'),
        new Person("Benji Li", 'ArtBot Member', 'im', 'im', 'assets/img/artbot/benji.png', 'im'),
    ];
    const Arm: Array<Person> = [
        new Person("Matthew Sam", 'Electrical Lead', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
        new Person("Danny Han", 'Mechanical Lead', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
    ...
    const Train: Array<Person> = [
        new Person("James Na", 'Electrical Co-Lead', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
        new Person("Robin Yuan", 'Electrical Co-Lead', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
        // new Person("David Kim", 'Mechanical Lead', 'im', 'im', 'assets/img/arm/david.png', "im"),
    ...
    const Gripper: Array<Person> = [
        new Person("Mohammed AJ", 'Co-Lead', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
        new Person("Ehsan Twal", 'Co-Lead', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
    ...
    const Software: Array<Person> = [
        new Person("Yousif El-Wishahy", 'Co-Lead', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
        new Person("Andrew Xie", 'Co-Lead', 'im', 'im', "assets/img/default_profile.jpg", 'im'),
    ...
    return (
        <section className="bg-white w-screen overscroll-none mt-16 pt-10 z-10">
            <div className="container">
                <h1 className="text-4xl mx-[5%] font-extrabold font-Roboto700 mb-20 text-gray-800 capitalize lg:text-5xl">Meet
                    The Team</h1>
                <div className='my-16 mx-[5%] mb-24'>
                    ...
                    <div className="grid grid-cols-1 mt-12 gap-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
                        {Leads.map((lead) => (
                            <Member name={lead.name} position={lead.position} linkedin={lead.linkedin}
                                    github={lead.github} img={lead.img} email={lead.email}/>
                        ))}
                    </div>
                </div>
                ...
                <div className='my-16 mx-[5%]'>
                    <h1 className="text-3xl font-lighter md:font-bold text-gray-800 capitalize -mb-4 lg:text-4xl">ArtBot
                        (Completed)</h1>
                    <div className="grid grid-cols-1 mt-12 gap-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
                        {ArtBot.map((lead) => (
                            <Member name={lead.name} position={lead.position} linkedin={lead.linkedin}
                ...
                <div className='my-16 mx-[5%]'>
                    <h1 className="text-3xl font-lighter md:font-bold text-gray-800 capitalize -mb-4 lg:text-4xl">RoboCup
                        Arm</h1>
                    <div className="grid grid-cols-1 mt-12 gap-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
                        {Arm.map((lead) => (
                            <Member name={lead.name} position={lead.position} linkedin={lead.linkedin}
